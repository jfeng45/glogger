...
func RegisterLog(lc *config.Logging) (glogger.Logger, error) {
...
func initLog(lc *config.Logging) (*zap.Logger, error) {
	rawJSON := []byte(`{
	 "level": "info",
     "Development": true,
      "DisableCaller": false,
...
func customizeLogFromConfig(cfg *zap.Config, lc *config.Logging) error {
